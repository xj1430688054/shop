...
<div class="container cart">
		...
		<div class="span24">
			...
			<form id="assess" action="${ pageContext.request.contextPath }/assess_saveAssess.action" method="post">
				<%-- <input type="hidden" name="oid" value="<s:property value="model.oid"/>"/> --%>
				<%-- <input type="hidden" name="uid" value="<s:property value="model.uid"/>"/> --%>
				<div class="span24">
					<p>
							评价内容：<input name="msg" type="text" value="<s:property value=""/>" style="width:550px; height:150px"    />
								<br />
							备注信息：<input name="remark" type="text" value="<s:property value=""/>" style="width:550px; height:50px"    />
								<br />
							<%-- <input name="pid" type="text"value="<s:property value="model.user.uid"/>" style="width:150px; display:none" /> 
							<input name="uid" type="text"value="<s:property value="model.user.phone"/>" style="width:150px; display:none" />  --%>
						...
						<p style="text-align:right">
							<a href="javascript:document.getElementById('assess').submit();">
