package cn.itbaizhan.shop.product.action;

import cn.itbaizhan.shop.assess.action.AssessAction;
...
//		assessAction.listAssess(product.getPid());
		Appconst.setPpid(product.getPid());
		return "findByPid";
	}
